<template>
  <header class="gc-topbar">
    ...
    <div class="nav-box">
      <span v-if="locale == 'zh'" class="title">有明云管理端</span>
      <span v-if="locale == 'en'" class="title">Grandinsight</span>
      <div class="right nav-icon">
        <a href="javascript: void(0);">
          <i class="icon icon-yuyan"></i>
        ...
        <div style="float: right" @mouseenter="enter" @mouseleave="leave">
          <ul class="currentUser">
            <li>
              <a href="javascript: void(0);"><i class="icon icon-account"></i>{{currentUser}}</a>
            </li>
          </ul>
